...
from core.logic.repository.order_rep import create_order_rep, update_order_status_rep
...
async def refund_order_logic(order_id, client, db):
    try:
        order = await update_order_status_rep(order_id, OrderStatus.REFUNDED, db)
